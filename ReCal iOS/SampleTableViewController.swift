...
//  ReCal iOS
//
//  Created by Naphat Sanguansin on 10/20/14.
...
class SampleTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let bottomConstraint = NSLayoutConstraint(item: testControl, attribute: .Bottom, relatedBy: .Equal, toItem: cell.contentView, attribute: .Bottom, multiplier: 1.0, constant: 0.0)
